...
def function5():    
   os.startfile(os.getcwd()+"/developers/index.html")
...
root.title("Project: FACE RECOGNITION")

#creating a text label
Label(root, text="ATTENDANCE SYSTEM",font=("times new roman",20),fg="white",bg="black",height=2).grid(row=0,rowspan=2,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
...
Button(root,text="Recognize + Attendance",font=('times new roman',20),bg="green",fg="white",command=function3).grid(row=5,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
